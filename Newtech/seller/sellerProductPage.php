            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-dark sidebar collapse">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="sellerProductPage.php">
                        ...
                        <div class="form p-4">
                            <form method="GET" action="">
                                <span class="add-button">
                                    <h5 class="p-2">Search Your Products ...</h5>
                                </span>
                                ...
                                <a href="addProduct.php" class="btn btn-primary" target="_blank"><i class="fas fa-plus"></i> Add Product</a>
                            </form>
                        </div>
                    </div>
                    <div class="mb-5"></div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit_purchase.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary" style="padding: 10px; " target="_blank"><i class="fas fa-edit"></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
