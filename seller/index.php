...
<head>
  ...
  <title>Seller Registration | New Tech</title>
</head>
...
<body class="d-flex justify-content-center align-items-center">
  ...
  <form id="registerForm" class="card m-5 p-5 w-50" method="POST" onsubmit="return signUp();">
    <ul class="nav nav-tabs mb-5">
      <li class="nav-item">
        <a class="nav-link text-dark" href="sellerLogin.php">Login</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active bg-success text-white" aria-current="page" href="register.php">Register</a>
      </li>
    </ul>
    <h1 class="text-center text-muted">Create an seller account</h1>
